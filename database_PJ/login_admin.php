...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $username = $_POST['username']; // 接收 AdminID
    $password = $_POST['password']; // 接收 Password

    try {
        // 查詢資料庫，檢查帳號和密碼是否正確
        $sql = "SELECT AdminID, AdminName FROM admin WHERE AdminID = :username AND Password = :password";
